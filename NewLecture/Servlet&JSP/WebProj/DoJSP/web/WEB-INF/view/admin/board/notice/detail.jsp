                ...
                <table class="table border-top-default">
                    ...
                    <tr>
                        ...
                        <c:if test="${!empty prevNotice}">
                            <td colspan="3"  class="text-align-left text-indent"><a class="text-blue text-strong" href="/admin/notice/detail?id=${prevNotice.id}">${prevNotice.title}</a></td>
                        </c:if>
                        <c:if test="${empty prevNotice}">
                    ...
                    <tr>
                        ...
                        <c:if test="${!empty nextNotice}">
                            <td colspan="3"  class="text-align-left text-indent"><a class="text-blue text-strong" href="/admin/notice/detail?id=${nextNotice.id}">${nextNotice.title}</a></td>
                        </c:if>
                        <c:if test="${empty nextNotice}">
