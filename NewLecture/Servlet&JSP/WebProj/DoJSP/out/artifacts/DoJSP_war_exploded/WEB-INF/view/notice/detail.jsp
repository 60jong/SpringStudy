            ...
            <div class="sub-menu">
                ...
                <nav id="member-menu" class="linear-layout">
                    ...
                    <ul class="linear-layout">
                        ...
                        <li><a href="/WEB-INF/view/notice/list.jsp"><img src="/images/txt-customer.png" alt="고객센터" /></a></li>
                    </ul>
                </nav>
        ...
        <main>
            ...
            <div class="margin-top first">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>작성일</th>
                        <td class="text-align-left text-indent" colspan="3"><fmt:formatDate pattern="yyyy년 MM월 dd일 hh시 mm분 ss초" value="${n.regDate}"/>	</td>
                    </tr>
                    <tr>
                        <th>작성자</th>
                        <td>${n.writerId}</td>
                        <th>조회수</th>
                        <td><fmt:formatNumber pattern = "####,####" value = "${n.hit}"/>원</td>
                    </tr>
                    <tr>
                        <th>첨부파일</th>
                            ...
                            <td style="text-align: left" colspan="3">
                                ...
                                <c:forTokens var="file" items="${n.files}" delims="," varStatus="st">
                                    ...
                                    <a href="naver.com" style="${style}">${fn:toUpperCase(file)}</a>
                                    </c:if>
                                    <c:if test="${st.last}">
                    ...
                    <tr class="content">
                        <td colspan="4">${n.contents}</div><div><br></div><div><a href="http://www.newlecture.com/resource/spring2.zip"><b><u><font size="5" color="#dd8a00">예제 다운로드하기</font></u></b></a></div><div><br></div><div><br></div></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="margin-top">
                <table class="table border-top-default">
                    ...
                    <tr>
                        <th>다음글</th>
                        <td colspan="3"  class="text-align-left text-indent"><a class="text-blue text-strong" href="">${}</a></td>
                    </tr>
