    ...
    <div class="content-container clearfix">
        ...
        <main class="main">
            ...
            <form action="list" method="post">
                <div class="notice margin-top">
                    ...
                    <table class="table">
                        ...
                        <c:forEach var="n" items="${nList}" varStatus = "st">
                            ...
                            <tr>
                                <td>${n.id}</td>
                                <td class="title indent text-align-left"><a href="/admin/board/notice/detail?id=${n.id}">${n.title}</a><span style="font-weight: bolder; color: red">[${n.comment_Count}]</span></td>
                                <td>${n.writerId}</td>
                                <td>
                                    <fmt:formatDate pattern="yyyy년 MM월 dd일" value="${n.regDate}"/>
                                </td>
                ...
                <c:set var="startNum" value="${page%5 == 0 ? page - 4 :page - page%5 + 1}" />
                    ...
                    <ul class="-list- center">
                        <c:forEach var="i" begin="0" end="4">
                            <c:if test="${lastNum>=startNum+i}">
                                <li><a class="-text- ${page==(startNum+i) ? 'orange' : 'gray'} bold" href="?p=${startNum+i}&f=${param.f}&q=${param.q}" >${startNum + i}</a></li>
                            </c:if>
                            <c:if test="${lastNum<startNum+i}">
                            </c:if>
                        </c:forEach>>
                ...
                <div class="text-align-right margin-top">
                    ...
                    <input type="hidden" name="allId" value="${ids}">
